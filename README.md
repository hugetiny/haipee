...
<p align="center">
  <strong>不止会说，更能行动</strong><br>
  一个聚合顶尖 AI 模型、真正自由开放的多平台智能助手
</p>

<p align="center">
  <a href="https://haipee.ai">🌐 官网</a> •
  <a href="#核心特性">✨ 特性</a> •
  <a href="#为什么选择-haipee">🎯 为什么选择</a> •
  <a href="#支持平台">💻 支持平台</a>
</p>
...
### 🤖 聚合顶尖 AI 模型
不再被单一厂商绑定。自由切换 **Gemini、Claude、OpenAI、DeepSeek** 等全球顶尖模型，哪个好用用哪个。
...
### 🖥️ 全平台覆盖
支持 **macOS、Windows、Linux、Android、iOS**，一个账号，全端同步，AI 随时在你身边。

### 🔄 灵活切换助手
不同场景用不同 AI。写作、编程、翻译、分析 —— 随时切换最适合的助手。
...
| 传统 AI 应用 | Haipee AI |
|-------------|-----------|
| 每个厂商一个 App，来回切换 | **一个平台，聚合所有模型** |
| 月付 $20，不管用没用 | **按量付费，透明消费** |
| 被单一厂商生态绑定 | **自由选择，随时切换** |
| 功能受限，无法定制 | **灵活适配各种场景** |
...
1. 访问 [haipee.ai](https://haipee.ai) 下载对应平台客户端
2. 注册账号，无需绑定信用卡
3. 选择你想使用的 AI 模型
4. 开始对话！
...
```
┌─────────────────────────────────────┐
│        客户端层 (Client Layer)        │  ← 多平台 App
│     macOS | Windows | Linux | iOS    │
├─────────────────────────────────────┤
│      智能交互层 (Interaction)         │  ← 灵活切换助手
├─────────────────────────────────────┤
│       模型接入层 (Model Access)        │  ← 厂商自由选
