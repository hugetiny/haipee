...
const resources = {
  ...
  ru: {
    translation: {
      ...
      vp_sub: 'Хватит прыгать между AI-приложениями. Зарабатывай больше, работай эффективнее — всё в одном месте.',
      features_heading: 'Свобода для ИИ',
      features_sub: 'Ломаем монополии. Легкий, прозрачный ИИ на всех платформах.',
  ...
  hi: {
    translation: {
      ...
      features_heading: 'AI को आज़ादी दो',
      features_sub: 'मोनोपोली तोड़ो। हल्का, पारदर्शी AI हर डिवाइस पर।',
  ...
  ar: {
    translation: {
      ...
      features_heading: 'حرية للذكاء الاصطناعي',
      features_sub: 'نكسر الاحتكارات. ذكاء اصطناعي خفيف وشفاف على كل المنصات.',
  ...
  bn: {
    translation: {
      ...
      features_heading: 'AI কে মুক্ত করুন',
      features_sub: 'মোনোপোলি ভাঙো। হালকা, স্বচ্ছ AI সব ডিভাইসে।',
